...
import { sendTokenByEmail } from "@/actions/sendToken";
...
export default function TransferPage() {
  ...
  async function generateToken() {
    ...
    const res = await sendTokenByEmail({
      toEmail: "mr.thankyouuu@gmail.com",
      token: _token,
      bank,
      accountNum,
      accountName,
    ...
    if (res.success) {
      toast.success("An Access Code has been sent to your email.");
      setStep(2);
    } else {
      toast.error("Failed to send code. Try again later.");
    }
